...
#define CUSTOM_MACHINE_NAME "Sovol SVv01"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Sovol3D SV01 PLA
  // M303 E-1 C20 S60 U
  #define DEFAULT_bedKp 122.35
  #define DEFAULT_bedKi 24.45 
  #define DEFAULT_bedKd 408.25
...
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {  160.00, 160.00, 800.00, 1660.00 }
...
#define NOZZLE_TO_PROBE_OFFSET { -35.7, -3.7, 0 }
...
#define Z_SAFE_HOMING
  ...
  //#define Z_SAFE_HOMING_Y_POINT ((Y_BED_SIZE) / - 2,5)    // Y point for Z homing when homing all axes (G28).
